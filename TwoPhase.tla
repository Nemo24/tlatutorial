...
RMRcvCommitMsg(r)  == /\ rmState[r] = "prepared"
...
RMRcvAbortMsg(r) == /\ rmState[r] = "prepared"
                /\ rmState' = [rmState EXCEPT ![r] = "aborted"]
                /\ msgs = msgs \union {[type |-> "Abort"]}
                /\ UNCHANGED<<tmState,tmPrepared>>
...
\* Last modified Mon Sep 16 23:14:12 IST 2019 by manoharm
\* Created Sat Sep 14 23:35:15 IST 2019 by manoharm